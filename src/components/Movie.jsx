...
const Movie = ({ movie, viewTrailer, closeCard }) => {
    ...
    return (
        ...
        <div className="card" data-testid="card-open-component" onClick={(e) => e.currentTarget.classList.add('opened')} >
            <div className="card-body text-center" data-testid={movie.title}>
            ...
            <button type="button" data-testid="hidden-button" className="close" onClick={(e) => myClickHandler(e)} aria-label="Close">
